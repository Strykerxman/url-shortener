...
class URL(Base):
    ...
    # Optional UTC datetime after which this short URL stops redirecting.
    ...
    def __repr__(self):
        ...
        return (
            f"<URL(id={self.id}, key={self.key}, target_url={self.target_url}, "
            f"is_active={self.is_active}, clicks={self.clicks}, expires_at={self.expires_at})>"
        )
